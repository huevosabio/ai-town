...
export const agentInputs = {
  ...
  finishRememberRejection: inputHandler({
    args: {
      operationId: v.string(),
      agentId,
    },
    handler: (game, now, args) => {
      ...
      if (
        ...
        console.debug(`Agent ${agentId} isn't remembering rejection ${args.operationId}`);
      } else {
        delete agent.inProgressOperation;
        delete agent.toRememberRejection;
      }
      return null;
    },
  }),
  finishReflectAndUpdatePlan: inputHandler({
    args: {
      operationId: v.string(),
      agentId,
    },
    handler: (game, now, args) => {
      ...
      if (
        ...
        console.debug(`Agent ${agentId} isn't replanning ${args.operationId}`);
      } else {
        delete agent.inProgressOperation;
        delete agent.toReplan;
      }
      return null;
    },
  }),
  ...
  createAgent: inputHandler({
    args: {
      ...
      hasSecretCode: v.optional(v.boolean()),
    },
    handler: (game, now, args) => {
