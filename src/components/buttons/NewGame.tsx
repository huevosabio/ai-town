...
export default function NewGameButton() {
  ...
  const curentWorld = useQuery(api.world.defaultWorldStatus); // this should fetch latest world for the user
  const userPlayerId = useQuery(api.world.userStatus, curentWorld ? { worldId: curentWorld.worldId } : 'skip'); // this should fetch the user's player id
